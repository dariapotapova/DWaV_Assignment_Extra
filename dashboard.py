...
with st.sidebar:
    ...
    st.caption("• Russia: Habr Career (587 vacancies)")
    st.caption("• International: The Muse API (3783 vacancies)")
...
with tab1:
    ...
    with col1:
        ...
        fig1.update_traces(textposition='outside', marker_color=RUSSIA_COLOR)
    ...
    with col2:
        ...
        fig2.update_traces(marker_colors=[RUSSIA_COLOR, '#6C757D'])
    ...
    with col3:
        ...
        fig3.update_traces(textposition='outside', marker_color='#27AE60')
    ...
    with col4:
        ...
        fig4.update_traces(textposition='outside', marker_color='#E67E22')
    ...
    fig5.update_traces(textposition='outside', marker_color='#8E44AD')
...
with tab2:
    ...
    with col1:
        ...
        fig6.update_traces(textposition='outside', marker_color=INTERNATIONAL_COLOR)
    ...
    with col2:
        ...
        fig7.update_traces(marker_colors=[INTERNATIONAL_COLOR, '#6C757D'])
    ...
    with col3:
        ...
        fig8.update_traces(textposition='outside', marker_color='#27AE60')
    ...
    with col4:
        ...
        fig9.update_traces(textposition='outside', marker_color='#E67E22')
    ...
    fig10.update_traces(textposition='outside', marker_color='#8E44AD')
    fig10.update_layout(showlegend=False, height=400)
    st.plotly_chart(fig10, use_container_width=True)

st.markdown("---")
st.markdown(
    "<div style='text-align: center; color: gray;'>Data sources: Habr Career (Russia) | The Muse API (International)</div>",
